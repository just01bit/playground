...
var logger = cloud_sdk_util_1.createLogger('usage-analytics');
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, axios_1.default
                    .get(mergedOption.uri, { params: __assign(__assign({}, getSWAParameters(mergedOption)), payloadToCustomParameters(data)) })
                    .catch(function (error) { return Promise.reject(cloud_sdk_util_1.errorWithCause('Failed to send usage analytics data.', error)); })];
        });
    });
}
...
function calledFromCentralDependency(callerPath) {
    var numNodeModulesInPath = callerPath.split(path_1.sep).filter(function (dir) { return dir === 'node_modules'; }).length;
