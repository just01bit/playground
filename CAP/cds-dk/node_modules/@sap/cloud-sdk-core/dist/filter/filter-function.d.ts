 ...
 */
export declare abstract class FilterFunction<EntityT extends Entity, ReturnT extends FieldType> {
    functionName: string;
 ...
 */
export declare type FilterFunctionParameterType<EntityT extends Entity> = number | string | Field<EntityT> | FilterFunction<EntityT, FieldType>;
