    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, xsuaa_service_1.clientCredentialsGrant(xsuaa, serviceCreds, opts)
                    ...
                    throw cloud_sdk_util_1.errorWithCause("Fetching an access token for service \"" + resolvedService.label + "\" failed!", error);
                })];
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, xsuaa_service_1.userTokenGrant(xsuaa.url, userJwt, serviceCreds.username, opts)
                    .then(function (userToken) { return xsuaa_service_1.refreshTokenGrant(xsuaa, serviceCreds, userToken.refresh_token, opts); })
                    .then(function (refreshToken) { return refreshToken.access_token; })
                    .catch(function (error) {
                    throw cloud_sdk_util_1.errorWithCause("Fetching a user approved access token for service \"" + resolvedService.label + "\" failed!", error);
                })];
        });
    });
}
...
function multiTenantXsuaaCredentials(userJwt) {
    ...
    if (userJwt) {
        var decodedJwt = typeof userJwt === 'string' ? util_1.decodeJwt(userJwt) : userJwt;
        if (!decodedJwt.iss) {
