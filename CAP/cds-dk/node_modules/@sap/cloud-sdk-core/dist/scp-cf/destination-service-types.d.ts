...
export declare type AuthenticationType = 'NoAuthentication' | 'BasicAuthentication' | 'OAuth2SAMLBearerAssertion' | 'OAuth2ClientCredentials' | 'ClientCertificateAuthentication';
