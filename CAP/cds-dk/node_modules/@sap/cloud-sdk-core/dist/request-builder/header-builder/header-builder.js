...
exports.buildHeadersForDestination = function (destination) {
    return cloud_sdk_util_1.asyncPipe(addSapClientHeader(destination.sapClient || undefined), exports.addProxyHeaders(destination.proxyConfiguration), exports.addLocationIdHeader(destination.cloudConnectorLocationId), authorization_header_1.buildAndAddAuthorizationHeader(destination))({});
};
function addSapClientHeader(sapClient) {
    return function (headers) { return cloud_sdk_util_1.assocSome('sap-client', sapClient)(headers); };
}
...
exports.addLocationIdHeader = function (locationId) { return function (headers) {
    return cloud_sdk_util_1.assocSome('SAP-Connectivity-SCC-Location_ID', locationId)(headers);
}; };
