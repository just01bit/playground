...
function filterSelects(selects) {
    ...
    return allFieldSelects.concat(selects.filter(function (select) { return !selectionLevels.includes(selectionLevel(select)); }));
}
function combineSelection(selects, initialCombination, parent) {
    ...
    return selects.reduce(function (combination, select) {
        var fullFieldName = getPath(parent, select._fieldName);
