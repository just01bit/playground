...
var ODataRequest = /** @class */ (function () {
     ...
     */
    ODataRequest.prototype.relativeUrl = function () {
        return "" + remove_slashes_1.removeTrailingSlashes(this.relativeResourceUrl()) + this.query();
    };
    /**
     ...
     */
    ODataRequest.prototype.relativeResourceUrl = function () {
        return remove_slashes_1.removeTrailingSlashes(this.relativeServiceUrl()) + "/" + this.config.resourcePath();
    };
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.headers()
                        .then(function (headers) { return (__assign({ method: _this.config.method, url: _this.url(), headers: headers, data: _this.config.payload, proxy: false }, http_agent_1.getAgentConfig(_this._destination))); })
                        .then(function (requestConfig) { return axios_1.default.request(requestConfig); })
                        .catch(function (error) { return Promise.reject(constructError(error, _this.config.method, _this.serviceUrl())); })];
            });
        });
    };
    return ODataRequest;
...
function constructError(error, requestMethod, url) {
    ...
    var s4SpecificMessage = cloud_sdk_util_1.propertyExists(error, 'response', 'data', 'error') ? messageFromS4ErrorResponse(error) : '';
    var message = [defaultMessage, s4SpecificMessage].join(' ');
    return cloud_sdk_util_1.errorWithCause(message, error);
}
function messageFromS4ErrorResponse(error) {
    return (cloud_sdk_util_1.propertyExists(error.response.data.error, 'message', 'value') ? error.response.data.error.message.value : '') + "\n" + JSON.stringify(error.response.data.error);
}
