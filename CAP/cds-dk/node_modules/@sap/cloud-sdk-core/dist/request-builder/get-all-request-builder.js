...
var GetAllRequestBuilder = /** @class */ (function (_super) {
     ...
     */
    function GetAllRequestBuilder(_entityConstructor) {
        var _this = _super.call(this, new odata_get_all_request_config_1.ODataGetAllRequestConfig(_entityConstructor)) || this;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.build(destination, options)
                        ...
                        .then(function (response) { return response.data.d.results.map(function (json) { return entity_deserializer_1.deserializeEntity(json, _this._entityConstructor, response.headers); }); })];
            });
        });
    };
