        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.build(destination, options)
                        ...
                        return Promise.reject(cloud_sdk_util_1.errorWithCause("The batch request failed! The destination provided: " + scp_cf_1.toDestinationNameUrl(destination) + " and the options: " + options + ".", error));
                    })];
            });
        });
    };
...
function buildResponse(response, entityToConstructorMap, lineBreak) {
    if (isChangeSet(response)) {
        return buildWritResponses(response, entityToConstructorMap, lineBreak);
    }
...
function toConstructableFromChangeSetResponse(responseBody, entityToConstructorMap) {
    var entityJson = responseBody.d;
    var type = entityJson.__metadata.type;
    var typeSplit = type.split('.');
    if (typeSplit.length !== 2) {
        throw Error("The type: " + type + " of the entity: " + entityJson + " is not valid.");
    }
    return entityToConstructorMap[typeSplit[1]];
}
...
function buildWritResponses(response, entityToConstructorMap, lineBreak) {
