...
class ResourceJsonSerializer {
    ...
    serializeComplex(propertyOrReturnType, data, selectItems, expandItems, eTagRequired) {
        ...
        try {
            ...
            Object.assign(result,
                this._serializeStructuralProperties(type, value, this._getSelectedPaths(selectItems), true),
        ...
        try {
            ...
            result.value = value.map(valueItem => {
                ...
                return valueItem === null ?
                    this._serializeNullValue(propertyOrReturnType) :
                    Object.assign({},
                        this._serializeStructuralProperties(type, valueItem, selectedPaths, true),
    ...
    _serializeEntity(entityTypeOrSet, data, selectedPaths, expandItems, eTagRequired, isKeyRequired) {
        ...
        const serializedStructProps = this._serializeStructuralProperties(entityType, data, selectedPaths,
            isKeyRequired);
     ...
     * @private
     */
    _serializeStructuralProperties(type, data, selectedPaths, isKeyRequired) {
     ...
     * @private
     */
    _serializeNavigationProperties(type, entitySetOrSingleton, data, expandItems, isKeyRequired) {
        if (!(typeof data === 'object')) {
        ...
        for (const [navPropertyName, navProperty] of type.getNavigationProperties()) {
            ...
            if (expandItem) {
                ...
                const expandedEntitySet = entitySetOrSingleton ?
                    entitySetOrSingleton.getRelatedBindingTarget(navPropertyName) : null;
    ...
    _serializePropertyValue(property, propertyValue, selectedPaths) {
        ...
        switch (property.getType().getKind()) {
            ...
            case EdmTypeKind.COMPLEX:
                return this._serializeStructuralProperties(property.getType(), propertyValue, selectedPaths);
            default:
                throw new SerializationError(
