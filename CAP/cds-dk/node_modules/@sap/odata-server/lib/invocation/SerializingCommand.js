...
class SerializingCommand extends Command {
            ...
            if (responseBody && typeof responseBody === 'object') {
                ...
                if (representationKind === RepresentationKinds.ENTITY
                    ...
                    if (!(responseBody.value && responseBody.value[MetaProperties.CONTEXT])) {
                        this._addContextUrl(representationKind, responseBody, request, options);
                    }
    ...
    /**
     * Adds the ContextUrl to a given responseBody.
     * @param {RepresentationKind.Kinds} representationKind representation kind of the target
     * @param {Object} responseBody the body of the response to add the ContextUrl
     * @param {OdataRequest} request the odata request
     * @param {Object} options optional keys for the building of the ContextUrl
     * @private
     */
    _addContextUrl(representationKind, responseBody, request, options) {
