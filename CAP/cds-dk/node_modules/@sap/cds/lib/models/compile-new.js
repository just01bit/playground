...
const compile = module.exports = Object.assign ((csn) => ({
    ...
    for: {
        ...
        odata: compile4odata,
        sql: cdsc.for.sql, // unsicher, ob wir das wieder brauchen
    },
...
/** Adds caching to cds.compile.for.odata */
...
else if (process.env.NODE_ENV !== 'test') console.warn ('[cds] - using new compiler options (snapi)')