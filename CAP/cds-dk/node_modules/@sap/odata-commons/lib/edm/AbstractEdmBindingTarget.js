...
class AbstractEdmBindingTarget {
    ...
    getNavigationPropertyBindings() {
        if (!this._navigationPropertyBindings) {
            this._navigationPropertyBindings = this._target.navigationPropertyBindings.map(binding =>
    ...
    getRelatedBindingTarget(inputPath) {
        ...
        const binding = this.getNavigationPropertyBindings().find(b => inputPath.startsWith(b.getPath()));
        if (binding) {
